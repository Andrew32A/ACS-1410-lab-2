...
*/
let response3 = stringToEmojis(word: "happy")
let response4 = stringToEmojis(word: "laughing")
let response5 = stringToEmojis(word: "cool")
let response6 = stringToEmojis(word: "bleh")
